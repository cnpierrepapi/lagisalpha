// SIGNAL CLASSIFIER — the read-only core of Lagisalpha (LOCKED framing, Jul 2 2026).
//
// Lagisalpha is a *provable line-integrity oracle*: it benchmarks an operator's price
