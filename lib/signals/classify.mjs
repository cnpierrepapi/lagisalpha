// SIGNAL CLASSIFIER — the read-only core of Linescout (LOCKED framing, Jul 2 2026).
//
// Linescout is a *provable line-integrity oracle*: it benchmarks an operator's price
