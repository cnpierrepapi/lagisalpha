// SIGNAL CLASSIFIER — the read-only core of Linethesis (LOCKED framing, Jul 2 2026).
//
// Linethesis is a *provable line-integrity oracle*: it benchmarks an operator's price
