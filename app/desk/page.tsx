...
export const metadata = { title: "The Desk: defend a live book | Lagisalpha" };
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-7xl px-5 py-12">
        ...
        <p className="mt-3 max-w-3xl text-sm text-muted">
          ...
          quote gets lifted. Lagisalpha watches this gap tick by tick; your rule-set decides what to do
