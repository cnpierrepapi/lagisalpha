...
// pickoffs Lagisalpha measured: each carries the book's price, TxLINE's vig-free fair,
    ...
    return NextResponse.json(
      {
        error: "unauthorized",
        message:
          "Provide an API key via 'Authorization: Bearer <key>' or 'X-Api-Key'. See /launch for API access.",
      },
