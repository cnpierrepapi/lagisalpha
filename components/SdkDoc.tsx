...
const REPO = "https://github.com/cnpierrepapi/lagisalpha";
  ...
  return (
    <div className="mx-auto max-w-5xl px-5 py-10">
      <header className="mb-10">
        ...
        <h1 className="serif mt-1 text-4xl text-paper">Lagisalpha API &amp; SDK</h1>
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-faint">
          Either way, Lagisalpha never places a bet, moves a price, or holds funds; your rule-set takes
      ...
      <section className="mb-12">
        ...
        <Code>{`curl -s https://lagisalpha.vercel.app/api/v1/signals \\
  -H "X-Api-Key: ag_demo_2026"

# only high-confidence fades on one fixture
curl -s "https://lagisalpha.vercel.app/api/v1/signals?action=fade&minConfidence=0.7" \\
  ...
  "fixtures": [
    {
      ...
      "signals": [
        ...
        <Code>{`POST https://your-endpoint.example/lagisalpha-signals
X-Lagisalpha-Signature: sha256=<hmac of body with your secret>
...
npm install github:cnpierrepapi/lagisalpha

# the public surface is the self-contained "lagisalpha/sdk" entry
import { EdgeEngine, classifyEdge, goalImminent, scoreCLV }
  from "lagisalpha/sdk";`}</Code>
      ...
      <section className="mb-10">
        ...
        <Code>{`import { EdgeEngine, classifyEdge, goalImminent } from "lagisalpha/sdk";
